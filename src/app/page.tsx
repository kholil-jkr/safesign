...
// SafeSign — single-page application (Brief §2, §4, §5, §8).
// Linear, single-focus flow: paste contract → wait → see results → (optional) chat.
// Mobile-first, calm blue-green palette, large legible text, no login,
// language auto-detected from the browser with a manual switcher.

import { useCallback, useEffect, useRef, useState } from "react";
import { Loader2, Lock, RotateCcw, ShieldCheck, Sparkles } from "lucide-react";
